...
//  CORE
//
//  Created by Jakub Ruranski on 27/09/2020.
//
...
struct WorkoutDetailView: View {
   ...
   @State var titleString: String = ""
    ...
    init(workout: Workout, showDetail: Binding<Bool>) {
        self.workout = workout
        self._titleString = State(initialValue: workout.name ?? "")
        self._showDetail = showDetail
        self._startingDate = State(initialValue: workout.startDate ?? Date())
        self._endingDate = State(initialValue: workout.endDate ?? Date().addingTimeInterval(3600))
        self._goalString = State(initialValue: "Select Goal") // change
        self._selectedLocation = State(initialValue: workout.location)
    }
    ...
    func save() {
        ...
        workout.name = titleString
        workout.startDate = startingDate
        workout.endDate = endingDate
...
struct WorkoutDetailView_Previews: PreviewProvider {
    static var previews: some View {
        WorkoutDetailView(workout: Workout(), showDetail: .constant(false))
    }
}
